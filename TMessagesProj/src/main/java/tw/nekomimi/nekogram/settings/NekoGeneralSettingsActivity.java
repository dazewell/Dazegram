...
public class NekoGeneralSettingsActivity extends BaseNekoXSettingsActivity {
    ...
    private final AbstractConfigCell physicalKeyboardHotkeysRow = cellGroup.appendCell(new ConfigCellTextCheck(NaConfig.INSTANCE.getPhysicalKeyboardHotkeys(), getString(R.string.PhysicalKeyboardHotkeysNotice)));
