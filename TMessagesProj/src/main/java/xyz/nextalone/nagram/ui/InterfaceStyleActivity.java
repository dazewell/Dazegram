...
public class InterfaceStyleActivity extends BaseFragment {
    ...
    private static final int ROW_LIQUID_GLASS = 1;
    private static final int ROW_MATERIAL_DESIGN_3 = 2;
    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            ...
            if (position == ROW_LIQUID_GLASS) {
                if (LiteMode.isLiquidGlassSupported()) {
                    setLiquidGlassEnabled(true);
                }
            } else if (position == ROW_MATERIAL_DESIGN_3) {
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == ROW_MATERIAL_DESIGN_3 || position == ROW_LIQUID_GLASS && LiteMode.isLiquidGlassSupported();
        }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        themeDescriptions.add(new ThemeDescription(listView, ThemeDescription.FLAG_CELLBACKGROUNDCOLOR, new Class[]{HeaderCell.class, RadioButtonCell.class}, null, null, null, Theme.key_windowBackgroundWhite));
