...
Extera Light and Extera Dark bring exteraGram's look to Dazegram. The design is [exteraGram](https://github.com/exteraSquad/exteraGram)'s. The palettes here were reverse-engineered rather than copied, and ship as Monet-token theme assets, but the look is exteraSquad's and the credit belongs to its authors.
