...
NagramX Settings → General has an Interface Style page for switching between Liquid Glass and Material Design 3. MD3 gives chat headers and chat-list top regions opaque edge-to-edge theme-colour surfaces while keeping search rounded. Its Apply to switches include future buttons and bottom navigation, and Blur strength replaces the old Composer transparency sliders while those MD3 blurred surfaces are built. Unsupported devices show MD3 and disable Liquid Glass.
