...
### Ghost icon stays put under stories
...
### Tidier scheduled selection bar
...
### External microphone toggle in video message popup
...
### Whisper transcription controls
...
### Retry a transcription with another provider
...
### Long-press the transcription button to switch providers
