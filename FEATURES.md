...
NagramX Settings → General has an Interface Style page for switching between Liquid Glass and Material Design 3. MD3 gives chat headers and chat-list top regions opaque edge-to-edge theme-colour surfaces while keeping search rounded. Its Apply to switches include Composer, buttons, and bottom navigation; Composer opts into a flat message field and under-keyboard surface. Blur strength remains shared for glass surfaces, while unsupported devices show MD3 and disable Liquid Glass.
