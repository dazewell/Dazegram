...
NagramX Settings → General has an Interface Style page for switching between Liquid Glass and Material Design 3. MD3 flattens the chat header and chat-list top panels to theme colours, with switches for each supported surface. Unsupported devices show Material Design 3 and disable Liquid Glass.
