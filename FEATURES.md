...
The toolbar row can be scaled from 75% to 125% in 5% steps. A second slider sets icon spacing, packing buttons closer without shrinking them. At small toolbar sizes, the tightest spacing steps will grey out to prevent icons from overlapping; when that happens the spacing footer tells you whether the value shown is your saved one or a temporary substitute, and that your saved spacing will come back once the toolbar is bigger.
