...
function Invoke-SelfTest([hashtable]$pins) {
    ...
    $ok = (Assert-Fails  'Test-LayerFloors(low)'  (Test-LayerFloors 171 63 599 262 $pins) ([ref]$log)) -and $ok
    $ok = (Assert-Fails  'Test-LayerFloors(rad)'  (Test-LayerFloors 172 62 599 262 $pins) ([ref]$log)) -and $ok
    $ok = (Assert-Passes 'Test-LayerFloors'       (Test-LayerFloors 172 63 599 262 $pins) ([ref]$log)) -and $ok
