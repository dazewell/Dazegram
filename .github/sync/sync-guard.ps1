...
function Invoke-SelfTest([hashtable]$pins) {
    ...
    $ok = (Assert-Fails  'Test-LayerFloors(low)'  (Test-LayerFloors 171 58 599 262 $pins) ([ref]$log)) -and $ok
    $ok = (Assert-Fails  'Test-LayerFloors(rad)'  (Test-LayerFloors 172 57 599 262 $pins) ([ref]$log)) -and $ok
    $ok = (Assert-Passes 'Test-LayerFloors'       (Test-LayerFloors 172 58 599 262 $pins) ([ref]$log)) -and $ok
