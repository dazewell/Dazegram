...
through `LauncherIconController.setIcon` (`LauncherIconController.java:71-78`),
...
(`LauncherIconController.java:29-63`), which only runs at app launch to
...
(`TMessagesProj/src/main/java/org/telegram/ui/LauncherIconController.java:80-102`) onto:
...
- `avatarContainer` is added with 52dp margins either side
